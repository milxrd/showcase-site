...
const MainComponent: React.FC = () => {
  const navItems = ['Lorem', 'ipsum', 'dolor']; //'O mnie', 'Blog', 'Kontakt'
  ...
  return (
    <>
    <div className="relative flex font-serif antialiased bg-hero-pattern bg-cover min-h-screen flex-col justify-center overflow-hidden bg-olive py-6 sm:py-12 ">
      <div className="relative text-black mx-2 px-6 pb-8 pt-10 sm:mx-auto sm:rounded-lg sm:px-10">
        <div className="mx-auto max-w-md pb-16">
          <Header title="Site title" navItems={navItems} />
        </div>
